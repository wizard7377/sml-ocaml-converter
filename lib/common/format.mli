...
val tyvar : string t
(** Print a type variable name as a valid identifier, taking care of the special
    treatment required for the single quote character in second position, or for
    keywords by escaping them with \#. No-op on "_". *)
