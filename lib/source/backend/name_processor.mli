...
module Make (Config : CONFIG) : sig
  ...
  val to_longident : ctx:Process_names.context -> string list -> Ppxlib.Longident.t
  ...
  val idx_to_longident : ctx:Process_names.context -> Ast.idx -> Ppxlib.Longident.t
  ...
  val process_name : ctx:Process_names.context -> string list -> Ppxlib.Longident.t * bool
