...
(** Additional information associated with a name. This currently includes
    constructor arity and module mapping. The reason for only these two has to
    do with the differences in SML and OCaml. *)
...
(** The core type of name stores. It maps certain kinds of names to their
...
(** Find all possible names that could be associated with the given root name,
    with a path TODO Module renaming/aliasing not yet implemented.
